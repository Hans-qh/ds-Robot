...
public class MailUtil {
    ...
    public static String myEmailAccount = "hans_qh@163.com";
    public static String myEmailPassword = "HDPLOKWBQMVTVISG"; //现在163只能使用授权码，不能使用密码。
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            mail.setTo("2253559277@qq.com");
            mail.setSubject("测试");
            mail.setContent("hello world ");
            sendMsg("2253559277@qq.com", mail);
